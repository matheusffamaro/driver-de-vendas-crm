...
// Só existe quando a extensão PDO MySQL está carregada. Este projeto usa PostgreSQL.
$mysqlSslCaAttr = null;
if (defined('PDO::MYSQL_ATTR_SSL_CA')) {
    $mysqlSslCaAttr = PDO::MYSQL_ATTR_SSL_CA;
...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'crm_whitelabel'),
